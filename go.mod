...
replace (
	...
	github.com/moby/buildkit => github.com/alexcb/buildkit v0.0.0-20230228232722-a41c95d22106
	github.com/tonistiigi/fsutil => github.com/alexcb/fsutil v0.0.0-20230228001620-fb1dd172da50
)
